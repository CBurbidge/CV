...
import Work from "./WorkAndSkills"
  ...
  render() {
    return (
      <div>
        ...
        {this.props.jsonResume.work.length > 0 && <Work work={this.props.jsonResume.work} skills={this.props.jsonResume.skills} skillsObj={this.props.skills} print={this.props.print} />}
